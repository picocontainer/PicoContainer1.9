...
# find src/java -name "*.java" | sed '/RedHerring/d' > .all_sources_for_default_picocontainer.txt
javac -target 1.8 -source 1.8 -d .bin/classes/ @.all_sources_for_default_picocontainer.txt
